...
import numpy as np
import torch
from sddpg_navigation.training.train_td3.td3_agent import Agent
from sddpg_navigation.environment import *
from sddpg_navigation.utility import *


def train_td3(run_name="TD3_R1", exp_name="Rand_R1", episode_num=(100, 200, 300, 400),
...
def main(args=None):
    ...
    train_td3(use_cuda=USE_CUDA, is_pos_neg=IS_POS_NEG, is_poisson=IS_POISSON,
